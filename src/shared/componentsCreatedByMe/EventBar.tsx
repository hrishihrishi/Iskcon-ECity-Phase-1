    ...
    <div className="w-full p-[2px] animate-aura-gold z-5">
      <nav className="bg-[#4b1d3f] text-[#FFD700] px-3 py-2 md:px-8 font-serif shadow-md w-full">
        <div className="max-w-9xl mx-auto flex flex-row items-center justify-between gap-2 md:gap-4">
          {/* Title */}
          <h1 className="text-md sm:text-md md:text-4xl font-bold tracking-wide text-left rounded-lg">
            {" "}
          ...
          <div className="flex items-center justify-end gap-2 md:gap-6">
            <div className="font-sans flex items-center gap-1 md:gap-2 text-xs md:text-2xl">
              <span>
                <strong className="text-sm md:text-3xl font-serif">
                  {timeLeft.days}
                </strong>
                d
              </span>
            ...
            <button
              onClick={() => {
                window.location.href = "/janmastami";
              }}
            ...
            >
              <span className="hidden md:inline mr-1">See programme</span>
              <svg
                className="w-4 h-4 md:w-6 md:h-6 font-extrabold stroke-[3]"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
