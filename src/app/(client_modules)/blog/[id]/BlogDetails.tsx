"use client";
// src/app/(client_modules)/blog/[id]/BlogDetails.tsx
// Pure client component — handles interactivity (votes, comments, optimistic UI).
  ...
  return (
    <div className="min-h-screen bg-[#fff8ef] text-[#221b00] pt-24 md:pt-28 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 mb-6">
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-[#4f453f]">
